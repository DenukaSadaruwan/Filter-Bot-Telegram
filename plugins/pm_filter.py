...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("Wallpaper", url="https://t.me/TheGalleryofficial"),
                InlineKeyboardButton("Wallpaper", url="https://t.me/TheGalleryofficial")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/TheGalleryofficial'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/TheGalleryofficial')
            ],
            [
                InlineKeyboardButton('Wallpapers', url=f'https://t.me/TheGalleryofficial')
            ]
            ]
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton('Wallpaper url=f'https://t.me/TheGalleryofficial')
            ]
            ]
        await query.answer()
        await client.send_cached_media(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/TheGalleryofficial'),
            InlineKeyboardButton('Wallpaper Club ⭕️', url='hhttps://t.me/TheGalleryofficial')
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Adult Bot 🔞', url='https://t.me/ukussaa_Bot')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/TheGalleryofficial'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ wallpaper", url="https://t.me/TheGalleryofficial"),
        InlineKeyboardButton("Wallpaper ⭕️", url="https://t.me/TheGalleryofficial")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/TheGalleryofficial")
    ])
